...
EXIT_TEXT = _GROUP_BOX.TextControl(searchDepth=1, AutomationId="lbSalir")
_ERROR_WINDOW = LOGIN_WINDOW.WindowControl(searchDepth=1, Name="MenuPrincipal")
WRONG_PASSWORD_TEXT = _ERROR_WINDOW.TextControl(searchDepth=1, Name="Clave Incorrecta")
